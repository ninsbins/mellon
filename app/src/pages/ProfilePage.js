...
const ProfilePage = () => {
    ...
    if (profileUsername === thisUsername) {
        return (
            <div>
                <Header/>
                                        ...
                                        <Tab.Pane eventKey={"recent"}>
                                            <Container className={"rounded-card"}>
                                                ...
                                                {posts ?
                                                    ...
                                                    : (
                                                        <Row className={"justify-content-center"}>{profileUsername} has no recent posts!</Row>
                                                    )
                                                }
                                            </Container>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey={"music"}>
                                            <Container className={"rounded-card"}>
                                                ...
                                                {musicPosts && musicPosts.length > 0 ?
                                                    ...
                                                    : (
                                                        <Row className={"justify-content-center"}>{profileUsername} has no music posts!</Row>
                                                    )
                                                }
                                            </Container>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey={"playlists"}>
                                            <Container className={"rounded-card"}>
                                                ...
                                                {playlistPosts && playlistPosts.length > 0 ?
                                                    ...
                                                    : (
                                                        <Row className={"justify-content-center"}>{profileUsername} has no playlist posts!</Row>
                                        ...
                                        <Tab.Pane eventKey={"movies"}>
                                            <Container className={"rounded-card"}>
                                                ...
                                                {moviePosts && moviePosts.length > 0 ?
                                                    ...
                                                    : (
                                                        <Row className={"justify-content-center"}>{profileUsername} has no movie posts!</Row>
                                                    )
                                                }
                                            </Container>
                                        </Tab.Pane>
                                            ...
                                            <Container className={"rounded-card"}>
                                                ...
                                                {recipePosts && recipePosts.length > 0 ?
                                                    <Row xs={2} sm={3} md={4} className="grid">
                                                        ...
                                                        <Row className={"justify-content-center"}>{profileUsername} has no recipe posts!</Row>
                                                    )
                                                }
                                            </Container>
                                        </Tab.Pane>
